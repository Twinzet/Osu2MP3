...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.backImage.setStyleSheet("border-image: url(OsuBackground.png);")
        ...
        self.titleLogo.setStyleSheet("Border-image: url(logoTitle.png)")
        ...
        self.sourceDirButton.setStyleSheet("border-image: url(folderIcon.png);")
        ...
        self.destDirButton.setStyleSheet("border-image: url(folderIcon.png);")
        ...
        danceGif = open(os.path.join("dance.gif"), "rb").read()
        ...
        self.menuLabel.setStyleSheet("border-image: url(pause-back1.png);")
        ...
        self.menuButton.setStyleSheet("""
            QPushButton {
                border-image: url(pause-back.png);
                border: none;
            }
            QPushButton:hover {
                border-image: url(pause-back1.png);
            }
        """)
